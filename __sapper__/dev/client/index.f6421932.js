import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, p as validate_each_argument, v as validate_slots, e as element, t as text, c as claim_element, b as children, f as claim_text, g as detach_dev, j as attr_dev, k as add_location, m as insert_dev, n as append_dev, r as set_data_dev, a as space, q as query_selector_all, h as claim_space, o as noop, u as destroy_each } from './client.7535d5be.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file, 22, 8, 332);
			add_location(li, file, 22, 4, 328);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			document.title = "Blog";
			add_location(h1, file, 18, 0, 272);
			attr_dev(ul, "class", "svelte-1dvgu2p");
			add_location(ul, file, 20, 0, 295);
		},
		m: function mount(target, anchor) {
